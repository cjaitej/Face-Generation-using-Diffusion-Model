...
args = Args()
args.run_name = 'FaceForge_Conditional_v2'
args.epochs = 500
...
args.sample_every = 10               # save a preview grid every N epochs
...
args.checkpoint_path = './models/faceforge_checkpoint_fast.pth.tar'
args.resume_checkpoint = None #args.checkpoint_path  # set to None to start over from scratch
